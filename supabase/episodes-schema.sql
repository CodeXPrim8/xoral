-- XORAL seasons & episodes — run AFTER cms-schema.sql
...
-- Allow larger video files in cms-media (adjust per Supabase plan)
-- Dashboard → Storage → cms-media → Settings → file size limit
